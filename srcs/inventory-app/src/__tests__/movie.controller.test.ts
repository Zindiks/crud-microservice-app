...
import { getMovieById, updateMovieById, deleteMoviesById } from '../controllers/movie.controller';
...
describe('Single Movie Controller', () => {
  ...
  describe('updateMovieById', () => {
    ...
    it('should handle duplicate title error during update', async () => {
      ...
      (Movies.update as jest.Mock).mockRejectedValueOnce(new UniqueConstraintError({}));
